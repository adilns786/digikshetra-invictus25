...
export default function MortgageCalculator() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-blue-100 p-10 lg:px-50 space-y-6">
      <div className="text-center">
        <h2 className="text-4xl font-bold tracking-tight text-blue-900">Mortgage Calculator</h2>
        <p className="text-blue-700">Estimate your monthly mortgage payments</p>
      </div>
      
      <div className="grid gap-6 md:grid-cols-2 max-w-4xl mx-auto">
        <Card className="shadow-lg border border-blue-300">
          <CardHeader>
            <CardTitle className="text-blue-800">Loan Details</CardTitle>
            <CardDescription>Enter your loan details to calculate payments</CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            <div className="space-y-2">
              <label htmlFor="home-price" className="text-sm font-medium flex items-center text-blue-900">
                Home Price
              </label>
              <div className="relative">
                ...
                <Input
                  id="home-price"
                  type="text"
                  className="pl-9 border-blue-400"
                  value={homePrice.toLocaleString()}
                  onChange={(e) => handleHomePriceChange(e.target.value)}
                />
              </div>
            ...
            <div className="space-y-2">
              <label htmlFor="down-payment" className="text-sm font-medium flex items-center text-blue-900">
                Down Payment
              </label>
              <div className="grid grid-cols-2 gap-4">
                <div className="relative">
                ...
                <div className="relative">
                  <Percent className="absolute left-3 top-2.5 h-4 w-4 text-blue-600" />
                  <Input
                    id="down-payment-percent"
                    type="text"
                    className="pl-9 border-blue-400"
