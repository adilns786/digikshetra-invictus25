  ...
  return (
    <div className="flex min-h-screen flex-col">
      ...
      <main className="flex-1">
        {/* Hero Section */}
        <section className="relative py-20 md:py-28 bg-gradient-to-b from-background to-muted">
          ...
          <div className="container mx-auto px-4">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              ...
              <div className="flex flex-col items-center text-center">
                ...
                <div className="text-muted-foreground">Dispute Reduction</div>
              </div>
              <div className="flex flex-col items-center text-center">
      ...
      <footer className="border-t py-8 bg-muted">
        <div className="container mx-auto px-4 flex flex-col md:flex-row justify-between items-center">
          <div className="flex items-center gap-2 mb-4 md:mb-0">
            ...
            <span className="font-bold">DigiLand Records</span>
          </div>
