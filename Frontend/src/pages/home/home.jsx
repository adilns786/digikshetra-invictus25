        ...
        <section className="relative py-20  md:py-28 bg-gradient-to-b from-gray-800 to-gray-900">
          <div className="container mx-auto px-4 flex flex-col md:flex-row items-center gap-8 md:gap-16">
            <div className="flex-1 space-y-6">
              ...
              Secure Land Records with <span className="text-blue-400">Blockchain & AI</span>
              </h1>
            <p className="text-lg text-gray-400 max-w-[600px]">
              ...
              <Button variant="outline" size="lg" className="border-blue-400 text-blue-400">
                  Learn More
                </Button>
              </div>
            </div>
  ...
  <div className="container mx-auto px-4">
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
      ...
      <div className="flex flex-col items-center text-center border border-blue-400 p-4 rounded-lg">
        ...
        {/* Features Section */}
        <section id="features" className="py-20 bg-muted bg-gradient-to-b from-gray-800 to-gray-900">
          <div className="container mx-auto px-4">
        ...
        <section id="how-it-works" className="py-20 bg-background">
          <div className="container mx-auto px-4">
            <div className="text-center mb-16">
      <h2 className="text-3xl md:text-4xl font-bold mb-4 text-blue-400">How It Works</h2>
      ...
      <div className="flex flex-col items-center text-center border border-blue-400 p-4 rounded-lg">
        ...
        <h3 className="text-xl font-bold mb-2 text-blue-400">Data Collection</h3>
      ...
      <div className="flex flex-col items-center text-center border border-blue-400 p-4 rounded-lg">
        ...
        <h3 className="text-xl font-bold mb-2 text-blue-400">Verification & Processing</h3>
        <p className="text-gray-400">
      ...
      <div className="flex flex-col items-center text-center border border-blue-400 p-4 rounded-lg">
        ...
        <h3 className="text-xl font-bold mb-2 text-blue-400">Secure Access</h3>
        <p className="text-gray-400">
    ...
    <h2 className="text-3xl md:text-4xl font-bold mb-6 text-blue-400">Ready to Transform Land Record Management?</h2>
    <p className="text-lg text-gray-400 max-w-[700px] mx-auto mb-8">
      ...
      <Button size="lg" className="gap-2 bg-blue-500 hover:bg-blue-600 text-white border border-blue-500">
      ...
      <Button variant="outline" size="lg" className="border-blue-400 text-blue-400">
        ...
        {/* Contact Section */}
        <section id="contact" className="py-20 bg-background bg-gradient-to-b from-gray-800 to-gray-900">
          <div className="container mx-auto px-4">
            <div className="text-center mb-16">
      ...
      <footer className="border-t py-8 bg-muted bg-gradient-to-b from-gray-800 to-gray-900">
        <div className="container mx-auto px-4 flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="text-sm text-muted-foreground">
            © {new Date().getFullYear()} DigiKshetra  Records. All rights reserved.
          </div>
